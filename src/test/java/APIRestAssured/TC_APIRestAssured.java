...
public class TC_APIRestAssured {
	private String _baseURL = "https://gorest.co.in/";
	private String _validAccessToken = "worVOCnb8RtfpSJod_ZzR76s5vQkBhQrjFLO";
	...
	public void t_02_get_request_valid_token() {
		...
		Response resp = given().
				...
				when().get("/public-api/users/30").thenReturn();
	...
	public void T_03_get_request_fetch_all_names()
	{
		Response resp=given().
				baseUri(_baseURL)
				.auth().oauth2(_validAccessToken).when().get("/public-api/users").thenReturn();
